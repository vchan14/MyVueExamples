...
export const ComponentBindingVue = createReplComponent(
  getVue("ComponentBinding"),
);
export const DimensionsVue = createReplComponent(getVue("Dimensions"));
export const EachBlockBindingVue = createReplComponent(
  getVue("EachBlockBinding"),
);
